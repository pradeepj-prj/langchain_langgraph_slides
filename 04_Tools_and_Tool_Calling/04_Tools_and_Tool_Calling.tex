...
% ============================================================================
\begin{frame}[fragile,shrink=3]{ToolMessage: Returning Tool Results to LLM}
...
% ============================================================================
\begin{frame}[fragile,shrink=3]{Multiple Tools in One Call}
...
% ============================================================================
\begin{frame}[fragile,shrink=3]{Tool Choice: Controlling When Tools Are Called}
...
% ============================================================================
\begin{frame}[fragile,shrink=2]{Built-in Tools: LangChain Provides Some}
...
% ============================================================================
\begin{frame}[fragile,shrink=2]{Async Tools: Non-blocking Execution}
...
% ============================================================================
\begin{frame}[fragile,shrink=3]{Input Validation and Sanitization}
...
% ============================================================================
\begin{frame}[fragile,shrink=2]{MCP Integration: Using MCP Tools with LangChain}
...
% ============================================================================
\begin{frame}[fragile,shrink=3]{Tool Calling Lifecycle (TikZ Diagram)}
\vspace{-0.25cm}
\begin{center}
...
% ============================================================================
\begin{frame}[fragile,shrink=3]{Real-World Example: Simple Agent Loop}
...
% ============================================================================
\begin{frame}[fragile,shrink=2]{Pitfall \#1: Missing or Vague Descriptions}
...
% ============================================================================
\begin{frame}[fragile,shrink=2]{Pitfall \#2: Missing or Wrong Type Annotations}
\begin{warningbox}[The Problem]
...
% ============================================================================
\begin{frame}[fragile,shrink=2]{Pitfall \#3: Forgetting ToolMessage in Chains}
\begin{warningbox}[The Problem]
...
% ============================================================================
\begin{frame}[fragile,shrink=2]{Pitfall \#4: Raising Exceptions Instead of Returning Errors}
\begin{warningbox}[The Problem]
...
% ============================================================================
\begin{frame}[fragile,shrink=2]{Pitfall \#5: Tools with Unintended Side Effects}
\begin{warningbox}[The Problem]
...
% ============================================================================
\begin{frame}[fragile,shrink=2]{Tool Composition with LCEL}
...
% ============================================================================
\begin{frame}[fragile,shrink=2]{Advanced: Retry Logic for Tools}
...
% ============================================================================
\begin{frame}[fragile,shrink=2]{Monitoring and Logging Tool Calls}
...
% ============================================================================
\begin{frame}[fragile,shrink=2]{Return Types: What Tools Should Return}
...
% ============================================================================
\begin{frame}[fragile,shrink=2]{Testing Tools Independently}
...
% ============================================================================
\begin{frame}[fragile,shrink=2]{Quick Reference: Tools Cheat Sheet}
