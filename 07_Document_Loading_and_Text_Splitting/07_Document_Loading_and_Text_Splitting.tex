...
print(doc.page_content)
  ...
  \begin{conceptbox}{Key Aspects}
    \begin{itemize}
    \setlength{\itemsep}{1pt}
      \item \texttt{page\_content}: Actual text
      \item \texttt{metadata}: Arbitrary key-value pairs
      \item Metadata preserved through pipeline
    \end{itemize}
  \end{conceptbox}
\end{frame}
...
chunks = RecursiveCharacterTextSplitter(
    chunk_size=1000).split_documents(docs)
...
splitter = TokenTextSplitter(
    encoding_name="cl100k_base", chunk_size=100)
